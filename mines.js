$(document).ready(function () {
    // Le code ne s'executeras pas tant que la page n'est pas charg�e
    ...
    * */
    ...
    let pari;//somme pari� par le user, on peut pas jouer si 0 ou moins
    let gameStarted = 0;
    let tabCoinsweeper = [];
    let loss = 0;
    let nbBombes;
    ...
    function clicCase() {
        ...
        if (loss == 0) {
            ...
            if (tabCoinsweeper[id] == 1) {
                ...
                tabCoinsweeper[id] = 2; //case cliqu� safe est pass�e � 2
                ...
                console.log("nombre de cases cliqu�es", nbCasesClique);
                nbCasesClique++;
    ...
    function game(bombeRandom) { //prend en parametre le nombre de bombes
        ...
        // et renvoie l'index de la valeur si celle ci est trouv�e dans le tableau.
        // renvoie -1 si rien n'est trouv�.

        let arr = [];
        while (arr.length < bombeRandom) { //rempli un tableau de random de 1 � 25 different de longeur bombeRandom
        ...
        /*
                ...
                console.log("la case pieg�e est: ", bombe)
